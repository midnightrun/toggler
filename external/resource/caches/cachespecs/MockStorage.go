...
// FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID mocks base method
func (m *MockStorage) FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID(ctx context.Context, flagID, envID, pilotExtID string) (*release.ManualPilotEnrollment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID", ctx, flagID, envID, pilotExtID)
	ret0, _ := ret[0].(*release.ManualPilotEnrollment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID indicates an expected call of FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID
func (mr *MockStorageMockRecorder) FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID(ctx, flagID, envID, pilotExtID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID", reflect.TypeOf((*MockStorage)(nil).FindReleasePilotByReleaseFlagAndDeploymentEnvironmentAndExternalID), ctx, flagID, envID, pilotExtID)
}
